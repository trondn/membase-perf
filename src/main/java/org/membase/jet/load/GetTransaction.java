...
/**
 * A Transaction type that implements a get operation to the membase cluster
 *
 * @author Trond Norbye
 * @version 1.0
 */
public class GetTransaction extends Transaction {
    ...
    /**
     * Initialize a new instance of the GetTransaction
     *
     * @param bindings The bindings for the test case
     * @throws TestinfraException if an error occurs
     */
    public GetTransaction(Bindings bindings) throws TestinfraException {
        super(bindings);
